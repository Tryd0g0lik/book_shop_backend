"""
scraper/project/celeryconfig.py:4

broker_url = < Look to the 'scraper/project/settings/settings_env.py' >
result_backend = < Look to the 'scraper/project/settings/settings_env.py' >
"""

from project.settings_conf.settings_env import REDIS_MASTER_NAME, REDIS_PASSWORD
