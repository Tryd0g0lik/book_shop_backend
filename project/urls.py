...
urlpatterns = [
    ...
    # ),
    # path("catalog/", lambda : pass, name="catalog") # !!! После удачной авторизации 'catalog/' указывается как
    # страница для релиректа
    ...
    path(
        "orders/", include(("orders.urls", "orders"), namespace="orders"), name="orders"
    ),
]
